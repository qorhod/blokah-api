...
//  انشا مستخدم جديد مع الاشتراك

router.post('/users-with-package', adminController.createUserWithPackage);


// انشاء البيانات الاساسيه 
router.post('/run/:userId', adminController.runSeed);
